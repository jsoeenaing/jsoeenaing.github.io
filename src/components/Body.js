                    ...
                    <CustomContainer title={'Work Experience'}><br/>
                       ...
                       <p>𝙏𝙪𝙩𝙤𝙧 𝙖𝙩 𝙁𝙧𝙞𝙚𝙣𝙙𝙨 𝙤𝙛 𝙎𝙞𝙢𝙤𝙣</p>
                                <ul>
                                    ...
                                    <li>𝘈𝘯𝘢𝘭𝘺𝘻𝘦𝘥 𝘢𝘯𝘥 𝘮𝘢𝘪𝘯𝘵𝘢𝘪𝘯𝘦𝘥 𝘳𝘦𝘤𝘰𝘳𝘥𝘴 𝘰𝘧 𝘴𝘵𝘶𝘥𝘦𝘯𝘵𝘴' 𝘱𝘳𝘰𝘨𝘳𝘦𝘴𝘴 𝘵𝘰 𝘵𝘦𝘢𝘤𝘩 𝘪𝘯𝘥𝘪𝘷𝘪𝘥𝘶𝘢𝘭 𝘯𝘦𝘦𝘥𝘴</li>
                                    <li>𝘐𝘮𝘱𝘭𝘦𝘮𝘦𝘯𝘵𝘦𝘥 𝘢𝘯𝘥 𝘳𝘢𝘯 𝘭𝘪𝘵𝘦𝘳𝘢𝘤𝘺 𝘢𝘯𝘥 𝘯𝘶𝘮𝘦𝘳𝘢𝘤𝘺 𝘢𝘤𝘵𝘪𝘷𝘪𝘵𝘪𝘦𝘴 𝘧𝘰𝘳 𝘢 𝘨𝘳𝘰𝘶𝘱 𝘰𝘧 𝘴𝘵𝘶𝘥𝘦𝘯𝘵𝘴</li>
                                </ul>
                        </BoxContainer>
                        <br/>
                        <BoxContainer>
                        <p>𝙎𝙖𝙡𝙚 𝘼𝙨𝙨𝙤𝙘𝙞𝙖𝙩𝙚 𝙖𝙩 𝙀𝙮𝙚𝙨𝙩𝙖𝙧 𝙊𝙥𝙩𝙞𝙘𝙖𝙡</p>
                                <ul>
                                    ...
                                    <li>𝘌𝘯𝘵𝘦𝘳𝘦𝘥 𝘯𝘦𝘸 𝘱𝘢𝘵𝘪𝘦𝘯𝘵/𝘤𝘶𝘴𝘵𝘰𝘮𝘦𝘳 𝘱𝘳𝘰𝘧𝘪𝘭𝘦𝘴 𝘢𝘯𝘥 𝘱𝘳𝘦𝘴𝘤𝘳𝘪𝘱𝘵𝘪𝘰𝘯 𝘪𝘯𝘵𝘰 𝘰𝘯𝘭𝘪𝘯𝘦 𝘴𝘺𝘴𝘵𝘦𝘮𝘴</li>
                                </ul>
                            </BoxContainer>
                    </CustomContainer>
            </div>
